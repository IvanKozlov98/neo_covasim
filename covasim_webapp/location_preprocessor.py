...
def make_people_from_pars(
    common_pars=CommonParameters(),
    household_pars=HouseholdParameters.get_default_parameters(),
    school_pars=SchoolParameters.get_default_parameters(),
    work_pars=WorkParameters.get_default_parameters(),
    random_pars=RandomParameters.get_default_parameters(),
    filename=None
):
    json_dict = dict()
    ...
    json_file_location = f'synthpops/synthpops/data/{common_pars.location}.json'
    with open(json_file_location, 'w') as json_file:
